...
// Ensure CLIENT_URL has a proper scheme for Stripe URL validation
const getClientUrl = () => {
    const url = ENV.CLIENT_URL || "http://localhost:5173";
    // If no scheme is present, default to http (dev) — in production set CLIENT_URL=https://yourdomain.com
